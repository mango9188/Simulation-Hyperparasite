...
#state <- c(H = 0.01, P1H = 0, P2H = 0, P1 = 0.01, P2 = 0.01, S = 0.5) #EP2H
#state <- c(H = 0.2, P1H = 0, P2H = 0, P1 = 0.01, P2 = 0.01, S = 0.5) #EC
state <- c(H = 0.7383519, P1H = 0.2883162, P2H = 0.1024059, P1 = 1.67909, P2 = 0.2674836, S = 0.9609926)
parms <- list(r = 1, K = 10,
