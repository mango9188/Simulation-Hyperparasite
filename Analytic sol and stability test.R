...
parms <- list(#H = 0.133791930, #0.133791930
  ...
  o1 = 0.8, o2 = 0.8, h1 = 1, h2 = 0.999, c1 = 0.9, c2 = 0.9, d = 0.03, DL = 0)
...
#Slove single equilibrium point----
parms_C = parms
...
#Solve for single equilibrium point_NEW----
#### Function setting----
{
Jacobian = function(parms, E) {
  with(c(parms, E), {
...
comp_out = expand.grid(m1 = seq(0.01, 0.1, by = 0.01), 
                       m2 = seq(0.01, 0.1, by = 0.01), 
                       d = seq(0.01, 0.05, by = 0.01))
...
comp_out <- as.data.frame(cbind(comp_out,
                                matrix(0, 
                                       ...
                                       ncol = 6 + 1)))
names(comp_out) <- c("m1", "m2", "d", "H", "P1H", "P2H", "P1", "P2", "S", "Stability")
...
#to solve alternative stable state----
