...
TimeSeriesInvasion(times, ini_High_H, parms_EC_E2H, InvasionTimes = c(100))
TimeSeriesInvasion(times, ini_Low_H, parms_EC_E2H, InvasionTimes = c(2000))

TimeSeriesInvasion(times, ini_High_H, parms_E1H_E2H, InvasionTimes = c(2000))
TimeSeriesInvasion(times, ini_Low_H, parms_E1H_E2H, InvasionTimes = c(2000))
