...
for(i in 1:dim(comp_out)[1]){
  ...
  E_C_maxH = f_E_C_maxH(temp_parms)
  E_C_minH = f_E_C_minH(temp_parms)
  E_S = f_E_S(temp_parms)
  E_P1 = f_E_P1(temp_parms)
  E_P2 = f_E_P2(temp_parms)
  E_P1H_minH = f_E_P1H_minH(temp_parms)
  E_P1H_maxH = f_E_P1H_maxH(temp_parms)
  E_P2H_minH = f_E_P2H_minH(temp_parms)
  E_P2H_maxH = f_E_P2H_maxH(temp_parms)
  
  #Check the eigen value of each equilibrium
  Lambda_E_C_maxH = Eigen(Jacobian(temp_parms, E_C_maxH))
  Lambda_E_C_minH = Eigen(Jacobian(temp_parms, E_C_minH))
  ...
  Lambda_E_P1H_maxH = Eigen(Jacobian(temp_parms, E_P1H_maxH))
  Lambda_E_P1H_minH = Eigen(Jacobian(temp_parms, E_P1H_minH))
  Lambda_E_P2H_maxH = Eigen(Jacobian(temp_parms, E_P2H_maxH))
  Lambda_E_P2H_minH = Eigen(Jacobian(temp_parms, E_P2H_minH))
  
  Stable_E = c()
  
  ###Check E_C
  if(all(E_C_minH == E_C_maxH, na.rm = T)){
    E_C = E_C_minH
    Lambda_E_C = Lambda_E_C_minH
    ...
    if(!is.na(Lambda_E_C_minH) && is.finite(Lambda_E_C_minH) && Lambda_E_C_minH < 0 && all(E_C_minH[c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] >= 0)){
      Stable_E = c("C_minH")
      comp_out[i, "Stability"] = "Stable"
      comp_out[i, c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] = E_C_minH
    }
    if(!is.na(Lambda_E_C_maxH) && is.finite(Lambda_E_C_maxH) && Lambda_E_C_maxH < 0 && all(E_C_maxH[c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] >= 0)){
      Stable_E = c(Stable_E, "C_maxH")
      comp_out[i, "Stability"] = "Stable"
      comp_out[i, c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] = E_C_maxH
    }
  }
  ...
  if(!is.na(Lambda_E_S) && is.finite(Lambda_E_S) && Lambda_E_S < 0 && all(E_S[c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] >= 0)){
    ...
    comp_out[i, "Stability"] = "Stable"
    comp_out[i, c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] = E_S
  }
  ...
  if(!is.na(Lambda_E_P2) && is.finite(Lambda_E_P2) && Lambda_E_P2 < 0 && all(E_P2[c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] >= 0)){
    ...
    comp_out[i, "Stability"] = "Stable"
    comp_out[i, c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] = E_P2
  }
  
  ###Check E_P1H
  if (all(E_P1H_minH == E_P1H_maxH, na.rm = T)) {
    E_P1H = E_P1H_minH
    Lambda_E_P1H = Lambda_E_P1H_minH
    ...
    if(!is.na(Lambda_E_P1H_minH) && is.finite(Lambda_E_P1H_minH) && Lambda_E_P1H_minH < 0 && all(E_P1H_minH[c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] >= 0)){
      Stable_E = c(Stable_E, "P1H_minH")
      comp_out[i, "Stability"] = "Stable"
      comp_out[i, c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] = E_P1H_minH
    }
    if(!is.na(Lambda_E_P1H_maxH) && is.finite(Lambda_E_P1H_maxH) && Lambda_E_P1H_maxH < 0 && all(E_P1H_maxH[c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] >= 0)){
      Stable_E = c(Stable_E, "P1H_maxH")
      comp_out[i, "Stability"] = "Stable"
      comp_out[i, c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] = E_P1H_maxH
    }
  }
  
  ###Check E_P2H
  if (all(E_P2H_minH == E_P2H_maxH, na.rm = T)) {
    E_P2H = E_P2H_minH
    Lambda_E_P2H = Lambda_E_P2H_minH
    ...
    if(!is.na(Lambda_E_P2H_minH) && is.finite(Lambda_E_P2H_minH) && Lambda_E_P2H_minH < 0 && all(E_P2H_minH[c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] >= 0)){
      Stable_E = c(Stable_E, "P2H_minH")
      comp_out[i, "Stability"] = "Stable"
      comp_out[i, c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] = E_P2H_minH
    }
    if(!is.na(Lambda_E_P2H_maxH) && is.finite(Lambda_E_P2H_maxH) && Lambda_E_P2H_maxH < 0 && all(E_P2H_maxH[c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] >= 0)){
      Stable_E = c(Stable_E, "P2H_maxH")
      comp_out[i, "Stability"] = "Stable"
      comp_out[i, c('H', 'P1H', 'P2H', 'P1', 'P2', 'S')] = E_P2H_maxH
    }
  }
