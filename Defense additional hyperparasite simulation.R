...
Invasion = 
  TimeSeriesInvasion(times, Initial, parms_EC_E2H, InvasionTimes = c(8500))

ggsave("m1 = 007 H = 3 invasion success.png", 
       plot = Invasion, 
       bg = "transparent", 
       width = 1600, 
       height = 1200, 
...
#### Save GIF
anim_save(filename = "m1 = 007 H = 3 invasion success.gif", GIF)