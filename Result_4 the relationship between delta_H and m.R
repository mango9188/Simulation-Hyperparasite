...
for (i in Invasion_timing) {
  ...
  temp_state = round(unlist(High_H_EC_E2H[round(High_H_EC_E2H$time, 2) == round(i, 1),  c("H", "P1H", "P2H", "P1", "P2", "S")]), 8)
...
saveRDS(High_H_EC_E2H, "Result 4 High_H_EC_E2H_invade_TimeSeries")
##Plotting----
#High_H_EC_E2H = readRDS("")
High_H_EC_E2H %>%
  filter(H_press != 0) %>%
  ggplot()+
