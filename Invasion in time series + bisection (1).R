...
for (i in Invasion_timing) {
  ...
  High_H_E1H_E2H[i,]$H_press = 
    Bisection_H(min_H = High_H_E1H_E2H[i, "H"],
                max_H = 25,
                state = temp_state,
                parms = parms_E1H_E2H)
...
##Plotting----
#High_H_E1H_E2H = readRDS("High_H_E1H_E2H_invade")
High_H_E1H_E2H %>%
  filter(H_press != 0) %>%
ggplot()+
  ...
  scale_x_log10()
ggsave("High_H_E1H_E2H_invasion.png", width = 14, height = 10, units = "cm", dpi = 800)
